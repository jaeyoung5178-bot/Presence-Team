...
const desktop = await page.evaluate(() => {
  ...
  return {
    ...
    previewChecks: {
      ...
      productivitySlide: preview.includes('실제 인컴에서 본드와 리젝을 역산했습니다') && preview.includes('리젝·본드 차감 완료 실인컴') && preview.includes('CLIENT REJECT') && preview.includes('SALESWORKS REJECT'),
      sharedDenominator: preview.includes('지급자료 역산 총생산성') && preview.includes('리젝 제외 본드 · 35÷65') && preview.includes('합계를 100%'),
...
if (desktop.productivity.unit !== 110000 || desktop.productivity.bondRate !== 0.35 || desktop.productivity.fieldDays !== 9 || desktop.productivity.sales !== 24 || desktop.productivity.actualIncome !== 1260 || desktop.productivity.performanceIncome !== 1210 || desktop.productivity.hourlyIncome !== 50 || desktop.productivity.netCL !== 3 || desktop.productivity.netSW !== 1 || desktop.productivity.retained !== 20 || desktop.productivity.grossValue !== 2640000 || desktop.productivity.estimatedBondValue !== 652 || desktop.productivity.afterBondValue !== 1260 || desktop.productivity.rejectValue !== 440000 || desktop.productivity.reconstructedValue !== 441912 || Number(desktop.productivity.rejectPctOfSales.toFixed(1)) !== 16.7 || Number(desktop.productivity.clPctOfSales.toFixed(1)) !== 12.5 || Number(desktop.productivity.swPctOfSales.toFixed(1)) !== 4.2 || Math.abs(desktop.productivity.modelPctTotal-100) > 0.000001) failures.push('Productivity, reverse-calculated bond, actual-income, or CL/SW one-ring breakdown is incorrect');
