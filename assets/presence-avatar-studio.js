(function(){
  ...
  function art(p,override,context){
    ...
    var color=p.color||'honey',tone=(COLORS.find(function(x){return x[0]===color;})||COLORS[0])[2],tint=0,feather=p.feather||'classic';
    ...
    html+='<img class="'+(integrated?'pgp-master':'pgp-base')+'" src="'+(master||ROOT+'presence-base-'+color+'.webp')+'" alt="" draggable="false">';
